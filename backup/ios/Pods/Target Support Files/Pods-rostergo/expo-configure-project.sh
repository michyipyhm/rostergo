...
with_node \
  ...
  --target "/Users/michaelyip/Documents/rostergo/mobile/ios/Pods/Target Support Files/Pods-rostergo/ExpoModulesProvider.swift" \
  --entitlement "/Users/michaelyip/Documents/rostergo/mobile/ios/rostergo/rostergo.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-keep-awake" "expo-linking" "expo-router" "expo-secure-store"
