...
with_node \
  ...
  --target "/Users/michaelyip/Documents/rostergo/mobile/ios/Pods/Target Support Files/Pods-mobile/ExpoModulesProvider.swift" \
  --entitlement "/Users/michaelyip/Documents/rostergo/mobile/ios/mobile/mobile.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-blur" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-haptics" "expo-image-picker" "expo-keep-awake" "expo-linking" "expo-router" "expo-secure-store" "expo-sharing" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
